...
//            btn.setText("B" + (++btn_id));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 10) {
                    btn.setBackgroundTintList(ContextCompat.getColorStateList(mContext.getApplicationContext(), R.color.light_red));
                } else {
                    btn.setBackgroundTintList(ContextCompat.getColorStateList(mContext.getApplicationContext(), R.color.purple_200));
                }
